    ...
    <form method="POST" action="{{ route_include_subdirectory('products.store', ['subdomain' => request()->route('subdomain')]) }}">
        ...
        <div class="grid-3">
            <div class="form-group">
                ...
                <input type="text" id="product_code" name="product_code" class="form-control" value="{{ old('product_code') }}" placeholder="Enter code" required>
                @error('product_code')
            ...
            <div class="form-group">
                ...
                <input type="text" id="product_name" name="product_name" class="form-control" value="{{ old('product_name') }}" placeholder="Enter name" required>
                @error('product_name')
                    <div class="error" style="color: #dc3545;">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="packing" name="packing" class="form-control" value="{{ old('packing') }}" placeholder="Enter packing">
                @error('packing')
                    <div class="error" style="color: #dc3545;">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="grid-4">
            <div class="form-group">
                ...
                <input type="number" id="opening_qty_box" name="opening_qty_box" class="form-control" value="{{ old('opening_qty_box') }}" min="0" placeholder="0">
            ...
            <div class="form-group">
                ...
                <input type="number" id="minimum_stock_box" name="minimum_stock_box" class="form-control" value="{{ old('minimum_stock_box') }}" min="0" placeholder="0">
            ...
            <div class="form-group">
                ...
                <input type="number" id="n_price_box" name="n_price_box" class="form-control" value="{{ old('n_price_box') }}" step="0.01" min="0" placeholder="0.00">
                @error('n_price_box')
                    <div class="error" style="color: #dc3545;">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="t_price_box" name="t_price_box" class="form-control" value="{{ old('t_price_box') }}" step="0.01" min="0" placeholder="0.00">
                @error('t_price_box')
                    <div class="error" style="color: #dc3545;">{{ $message }}</div>
                @enderror
            </div>
        ...
        <div class="grid-4">
            <div class="form-group">
                ...
                <input type="number" id="r_price_box" name="r_price_box" class="form-control" value="{{ old('r_price_box') }}" step="0.01" min="0" placeholder="0.00">
                @error('r_price_box')
                    <div class="error" style="color: #dc3545;">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="sales_tax" name="sales_tax" class="form-control" value="{{ old('sales_tax') }}" step="0.01" min="0" max="100" placeholder="0.00">
                @error('sales_tax')
                    <div class="error" style="color: #dc3545;">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" id="rate_in_percent" name="rate_in_percent" class="form-control" value="{{ old('rate_in_percent') }}" step="0.01" min="0" max="100" placeholder="0.00">
        ...
        <div style="display: flex; gap: 8px; margin-top: 10px;">
            <button type="submit" class="btn" style="padding: 6px 16px; font-size: 12px;">Create Product</button>
