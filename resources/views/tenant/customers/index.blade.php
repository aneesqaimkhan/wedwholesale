...
<div class="card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
        ...
        <a href="{{ route_include_subdirectory('customers.create', ['subdomain' => request()->route('subdomain')]) }}" class="btn">Add New Customer</a>
    </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route_include_subdirectory('customers.show', ['subdomain' => request()->route('subdomain'), 'customer' => $customer->id]) }}" class="btn btn-success" style="padding: 5px 10px; font-size: 12px;">View</a>
                        <a href="{{ route_include_subdirectory('customers.edit', ['subdomain' => request()->route('subdomain'), 'customer' => $customer->id]) }}" class="btn btn-warning" style="padding: 5px 10px; font-size: 12px;">Edit</a>
